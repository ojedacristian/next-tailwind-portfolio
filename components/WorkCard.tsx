...
export const WorkCard: React.FC<WorkCardProps> = ({align, work }) => {
    return (
        <article className={`flex flex-col ${align % 2 ? 'md:flex-row-reverse' : 'md:flex-row'} my-14 lg:my-24 text-neutral-2`}>
                        ...
                        <div className={`flex flex-col pb-8 ${align % 2 ? 'text-right pr-8 items-end' : 'text-left md:pl-8'} md:justify-end md:pb-0`}>
                            ...
                            <button className={`group uppercase flex justify-center p-2 rounded-full w-44 border text-neutral-1 border-neutral-2 text-h5 hover:bg-gradient-to-tl from-purple-600 to-pink-600 transition-all hover:scale-110 ${ align%2 ? 'hover:-translate-x-3' : 'hover:translate-x-3'} hover:border-white`}>
                                <p>View Work</p>
